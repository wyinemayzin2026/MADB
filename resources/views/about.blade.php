            ...
            <div
                ...
                <div
                    ...
                    <div class="w-[calc(100%-4rem)] md:w-[45%] p-6 rounded-2xl bg-white shadow-lg border border-gray-100">
                        ...
                        <p class="text-gray-600 mt-2 fs text-justify leading-relaxed">
                            မြန်မာနိုင်ငံ လွတ်လပ်ရေးရရှိပြီးနောက် တောင်သူလယ်သမားများအား
                            ...
                            အကြွေးဝန်ထုပ်ဝန်ပိုးမှ ကယ်တင်ရန်ဖြစ်ပါသည်။
                        </p>
                    </div>
                </div>
                <div class="relative flex items-center tp justify-between md:justify-normal md:odd:flex-row-reverse group">
                    ...
                    <div class="w-[calc(100%-4rem)] md:w-[45%] p-6 rounded-2xl bg-white shadow-lg border border-gray-100">
                        ...
                        <p class="text-gray-600 mt-2 fs text-justify leading-relaxed">
                            ၁၉၆၇ ခုနှစ်တွင် ဘဏ်စနစ်များကို ပြောင်းလဲခဲ့ရာ
                            ...
                            "စိုက်ပျိုးရေးချေးငွေဌာန" အနေဖြင့် လုပ်ငန်းများကို ဆက်လက်ဆောင်ရွက်ခဲ့ပါသည်။
                        </p>
                    </div>
                </div>
                <div class="relative flex tp items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
                    ...
                    <div class="w-[calc(100%-4rem)] md:w-[45%] p-6 rounded-2xl bg-white shadow-lg border border-gray-100">
                        ...
                        <p class="text-gray-600 mt-2 fs text-justify leading-relaxed">
                            ၁၉၇၅ ခုနှစ်တွင် ပြဋ္ဌာန်းခဲ့သော ဘဏ်များဥပဒေအရ ၁၉၇၆ ခုနှစ်၊ ဧပြီလ
                            (၁) ရက်နေ့တွင် "မြန်မာ့စိုက်ပျိုးရေးဘဏ်" (Myanma Agricultural Bank - MAB) အဖြစ်
                            သီးခြားဘဏ်တစ်ခုအနေဖြင့် ပြန်လည်ဖွဲ့စည်း တည်ထောင်ခဲ့ပါသည်။
                        </p>
                    </div>
                </div>
                ...
                <div class="relative flex tp items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
                    ...
                    <div class="w-[calc(100%-4rem)] md:w-[45%] p-6 rounded-2xl bg-white shadow-lg border border-gray-100">
                        <time class="font-bold text-green-700 text-xl">၄။ မြန်မာ့လယ်ယာဖွံ့ဖြိုးရေးဘဏ် ဥပဒေ (၁၉၉၀
                            ခုနှစ်)</time>
                        <p class="text-gray-600 mt-2 fs text-justify leading-relaxed">
                            နိုင်ငံတော်ငြိမ်ဝပ်ပိပြားမှု တည်ဆောက်ရေးအဖွဲ့ (နဝတ) လက်ထက်တွင်
                            ...
                            ဖွံ့ဖြိုးရေးအတွက် ငွေကြေးဝန်ဆောင်မှုများကို အရှိန်အဟုန်ဖြင့် ဆောင်ရွက်လာခဲ့ပါသည်။
                        </p>
                    </div>
                </div>
                ...
                <div class="relative flex tp items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
                    ...
                    <div class="w-[calc(100%-4rem)] md:w-[45%] p-6 rounded-2xl bg-white shadow-lg border border-gray-100">
                        ...
                        <p class="text-gray-600 mt-2 fs text-justify leading-relaxed">
                            ...
                            ယနေ့တိုင် အဆိုပါဝန်ကြီးဌာနအောက်တွင် ရပ်တည်လျက်ရှိပါသည်။
                        </p>
                    </div>
                </div>
            </div>
