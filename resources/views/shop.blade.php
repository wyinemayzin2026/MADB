        ...
        <div id="loan-list" class="hidden mt-4 space-y-2">
            @php
                $loans = [
                    [
                        'id' => 1,
                        'title' => 'နွေစိုက်ပျိုးရေးချေးငွေ (Summer Crop Loan)',
                        'image' => asset('assets/img/Lal.png'),
                        'desc' => 'နွေရာသီတွင် စိုက်ပျိုးမည့် သီးနှံများအတွက် ထုတ်ပေးသော ချေးငွေဖြစ်သည်။ မျိုးစေ့၊ ဓာတ်မြေဩဇာ၊ ပိုးသတ်ဆေး၊ စက်ယန္တရားငှားရမ်းခနှင့် အလုပ်သမားစရိတ်များအတွက် အသုံးပြုနိုင်သည်။တောင်သူလယ်သမားများ၏ စိုက်ပျိုးရေးကုန်ကျစရိတ်ကို အထောက်အကူပြုရန် ရည်ရွယ်သည်။ချေးငွေကို သီးနှံရိတ်သိမ်းပြီးနောက် သတ်မှတ်ကာလအတွင်း ပြန်လည်ပေးဆပ်ရသည်။'
                    ],
                    [
                        'id' => 2,
                        'title' => 'ဆောင်းစိုက်ပျိုးရေးချေးငွေ (Winter Crop Loan)',
                        'image' => asset('assets/img/Lal.png'),
